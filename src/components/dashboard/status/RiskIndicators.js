...
const mapStateToProps = state => ({
    riskIndicators: state.Dashboard.riskIndicators
})
...
const RiskIndicators = (props) => {
    let arrayGroup = chunkArray(props.riskIndicators, 3)
    let arrayLength = props.riskIndicators.length;
    return (
        <View>
            <View style={{ alignItems: 'center' }}>
                <Image style={{ width: 30, height: 30 }} source={require('../../../assests/images/emoji/05.svg')} />
            </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(RiskIndicators);